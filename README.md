...
Foi utilizado o Claude no VS Code como ferramenta agêntica de apoio ao desenvolvimento. A ferramenta analisou o codigo original, leu a documentacao, implementou blocos incrementais, auxiliou nas revisoes, executou validacoes e ajudou a manter a separacao entre Model, Control e View.

O uso do Claude corresponde a uma ferramenta agêntica equivalente ao fluxo proposto na atividade: analise do projeto, planejamento incremental, implementacao assistida, revisao e verificacao por comandos.
